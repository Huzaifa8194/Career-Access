...
export const participants: Participant[] = [
  {
    ...
    referralSource: "Paterson Free Public Library",
  },
  {
    id: "p_1043",
    firstName: "Aaliyah",
    ...
    referralSource: "Hudson County Workforce Development",
  },
  {
    id: "p_1044",
    firstName: "Marcus",
    ...
    referralSource: "IBEW — North Jersey",
  },
  {
    id: "p_1045",
    firstName: "Sasha",
  ...
  },
  {
    ...
    referralSource: "North Jersey Workforce Fair",
  },
  {
    id: "p_1047",
    firstName: "Renée",
    ...
    risk: "ok",
    goals: "Started Spring B at Bergen Community College — accounting associate.",
    educationLevel: "High school diploma",
    supportNeeded: ["FAFSA", "College apps"],
    referralSource: "Bergen County One-Stop",
  },
  {
    id: "p_1048",
    firstName: "Tomás",
  ...
  },
  {
    ...
    lastActivity: "Today",
    risk: "ok",
    goals: "Medical assistant certification through partner provider.",
    educationLevel: "Associate degree",
    supportNeeded: ["Career advising", "Childcare"],
    referralSource: "Passaic County Workforce Development",
  },
];
...
export const participantSummary = {
  ...
  intake: {
    contact: {
      email: "jordan.h@example.com",
      phone: "(201) 555-0142",
      address: "214 Market St, Paterson NJ 07505",
    },
